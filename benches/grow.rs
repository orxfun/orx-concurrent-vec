...
fn with_scope<T, P: PinnedVec<Option<T>>>(
    num_threads: usize,
    num_items_per_thread: usize,
    do_sleep: bool,
    compute: fn(usize, usize) -> T,
            ...
            |b, _| {
                b.iter(|| {
                    black_box(with_arc(
                        ...
                        add_workload,
                        compute_large_data,
                        ConcurrentVec::with_linear_growth(12),
                    ))
                })
            },
        );
            ...
            |b, _| {
                b.iter(|| {
                    black_box(with_arc(
                        ...
                        add_workload,
                        compute_large_data,
                        ConcurrentVec::with_fixed_capacity(1_048_576),
                    ))
                })
            },
        );
